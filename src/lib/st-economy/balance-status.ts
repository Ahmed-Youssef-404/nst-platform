...
// from the student's current-Level LevelStBalance. This keeps it always
// correct (no risk of a stale "isWarning" flag going out of sync with the
// real balance).
//
...
export function getBalanceStatus(
    ...
    return { levelSt, avgSt, zone, warningThreshold };
}