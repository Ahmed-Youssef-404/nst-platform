...
//             Currently: My Sessions, ST History, Send Feedback. Store/
//             Profile will be added the same way once those doors land.
...
import { CalendarCheck, Coins, MessageSquareWarning } from "lucide-react";
import {
    Sidebar,
    SidebarContent,
    SidebarFooter,
