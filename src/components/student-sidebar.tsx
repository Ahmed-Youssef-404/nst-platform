...
//             Currently: My Sessions, Ranking, Level History, ST History,
//             Send Feedback. Store/Profile will be added the same way
//             once those doors land.
...
import { CalendarCheck, Coins, History, MessageSquareWarning, Trophy } from "lucide-react";
import {
    Sidebar,
    SidebarContent,
    SidebarFooter,
...
const NAV_ITEMS = [
    ...
    { href: "/student/levels", label: "Level History", icon: History },
