// src/components/login-form-fields.tsx
"use client";
...
/**
 * The actual login form (tabs + fields + submit). Extracted from the Card
 * shell so it can be dropped into a page (see /login) or a Dialog (see the
